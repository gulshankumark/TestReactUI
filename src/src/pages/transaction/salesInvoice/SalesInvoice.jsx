...
class SalesInvoice extends React.Component {
    ...
    print(value) {
        ...
        SalesInvoiceService.DownloadSalesInvoice(id, invNumber).then((response) => {
            return response;
        });
    }

    RedirectPage() {
        const { from } = this.props.location.state || { from: { pathname: '/app/salesInvoice/CreateSalesInvoice' } };
