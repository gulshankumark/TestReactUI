...
class CreateSalesInvoice extends React.Component {
    ...
    componentDidMount() {
        ...
        VoucherSettingService.proformaInvoiceSettingType().then((setting) => {
    ...
    RedirectPage() {
        const { from } = this.props.location.state || { from: { pathname: '/app/ProformaInvoice/ProformaInvoice' } };
            ...
            <>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Create Proforma Invoice</Card.Title>
                        ...
                        <Formik
                            ...
                            onSubmit={(
                                ...
                                ProformaInvoiceService.CreateProformaInvoice(
                            ...
                            render={({ values, errors, status, touched, isSubmitting }) => (
                                <BlockUi tag="div" blocking={this.state.blocking}>
                                    <Form>
                                        <Card>
                                            <Card.Header>
                                                <Card.Title as="h5">Proforma Information</Card.Title>
                                            </Card.Header>
                                            <Card.Body>
