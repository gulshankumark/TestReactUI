...
class TrialBalance extends Component {
    ...
    componentDidMount() {
        TrialBalanceService.getTrialBalance(this.state.fromDate, this.state.toDate).then((x) => {
    ...
    DownloadReport() {
        TrialBalanceService.DownloadTrailBalanceReport(
            moment(this.state.fromDate).format('YYYY/MM/DD'),
            moment(this.state.toDate).format('YYYY/MM/DD')
        ).then((x) => {
            return x;
            ...
            <>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Trial Balance</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <div className="row">
