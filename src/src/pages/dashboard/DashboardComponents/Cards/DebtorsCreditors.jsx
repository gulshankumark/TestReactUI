...
class DebtorsCreditors extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    DashboardService.GetSundryDebtorsCreditorsSummary().then((x) => {
      ...
      <>
        <Row>
          <Col>
            <Card>
              <Card.Header>
                <Card.Title as="h5" className='text-blueGray-400 uppercase font-bold text-xs'>Debtors & Creditors</Card.Title>
                      ...
                      {this.state.loadGrid && (
                        <React.Fragment>
                          ...
                          >
                            ...
                            <Column dataField="item2" caption="Amount" alignment="right" />
                            {/* <Summary>
                              <TotalItem
                              column="item2"
                              summaryType="sum"
